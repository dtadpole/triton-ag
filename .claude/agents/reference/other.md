# Other Reference (RNN, SSM, mixed op types)
...
8. **fp16 for RNNs**: Tier 3-4 -- Only helps when GEMM sizes are large (>1024). For small batch/hidden (10/256), adds overhead with no tensor core benefit.
