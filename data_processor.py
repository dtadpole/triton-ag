...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="shared/finetune_raw_experiences")
    parser.add_argument("--output_dir", type=str, default="shared/finetune_processed_experiences")
